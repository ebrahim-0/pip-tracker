        ...
        <div id="container">
            <div id="vid_container">
                <IconButton onClick={handleCancel}
                            sx={{position: 'absolute', zIndex: 99, color: colors.grey[200], left: '12px', top: '12px'}}>
                    <ArrowCircleLeftOutlined fontSize='large' />
                </IconButton>
                <CaptureSettings onPreviewChange={handleLivePreviewChange} onDebugChange={handleDebugChange}
                                 livePreview={livePreview.current} debug={debug.current} />
                <Webcam
                    ref={webcamRef}
                    muted={true}
                    id='video'
